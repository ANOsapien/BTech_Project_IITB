...
string make_run_dir(){
    ...
    // Find a non-existing folder name by trying to open a sentinel file
    ...
    // Create folder via system call — works on Windows and Linux
...
// ================= INITIALIZE =================
// // concentric rings with tangential velocity
...
int main(){
    ...
    // --- create run folder and save params ---
    ...
    // save initial state before any update
